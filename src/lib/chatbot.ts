...
export const anthropic = new Anthropic({
  apiKey:
    "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", // defaults to process.env["ANTHROPIC_API_KEY"]
});
